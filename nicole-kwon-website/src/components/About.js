  ...
  <div className="aboutcontainer">
    ...
    <div className="aboutbody">
      ...
      <div className="aboutdescription">
        ...
        <p className="aboutparagraph"> i've been working as a software engineer at publicis sapient, a digital transformation consulting company, for 3 years, and i was promoted from junior to associate after a year. when i first started, i account shadowed and helped keurig with their quality assurance on their react native mobile app. i validated jira stories and defects from active sprints by utilizing testflight and postman, and i emulated brewers for testing and ensuring successful product delivery. last year, i worked with hy-vee as a frontend developer alongside 4 other engineers, where we hold ownership on jira stories to transform wireframes into react native reality. now, i'm working for wegmans, another grocery store chain with a react native mobile application, and i've been optimizing state management using lazy loading and memorization techniques. </p>
        <p className="aboutparagraph"> 
          <span>if you have any questions or want to learn more about me, feel free to reach out to me at </span>
